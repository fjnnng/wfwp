...
class MediaPlayer:
    ...
    def generate(self, monitors=[]):
        ...
        for monitor in self.monitors:
            filename = api.getwallpaper(monitor, filter=self.dir)
    ...
    def blacklist(self, indexes=None):
        ...
        with open(fnc.BLACKLIST, "w", encoding="utf-8") as file:
