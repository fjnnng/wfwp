...
- wfwp redetects monitors before every action requiring an up-to-date list of them and after every time an added or removed screen signals from Qt. But it is not designed to be aggressive, so sometimes "Manual..." -> "Detect Monitors" may be useful.
